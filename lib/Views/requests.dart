...
Future<List<Request>> fetch() async {
  final response = await http.get(
    Uri.parse('$BaseUrl/api/RequestsSent'),
    headers: {
...
class _requestsState extends State<requests> {
  ...
  late Future<List<Request>> futurePost;
          ...
          Center(
              child: RichText(
                text: TextSpan(
                  ...
                  text: 'قائمة طلبات بدء المحادثة المرسلة',
                ),
              )),
          SizedBox(
            height: 30,
                                              ...
                                              onPressed: () async {
                                                ...
                                                showDialog<String>(
                                                    ...
                                                    context) =>
                                                        AlertDialog(
                                                            title: const Text(
                                                                'تم ازالة هذا الشخص من قائمة بدء المحادثة بنجاح'),
